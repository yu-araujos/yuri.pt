...
const TopBar: React.FC = () => {
  return (
    <div className="flex items-center justify-between  w-full md:w-11/12 px-4 py-2 bg-black bg-opacity-80 rounded-t-xl border-b-[1px] border-opacity-10 border-gray-300">
