...
const TopBar: React.FC = () => {
  return (
    <div className="flex items-center justify-between  w-full md:w-11/12 px-4 py-2 bg-black bg-opacity-70 rounded-t-xl border-b-[1px] border-opacity-90 border-gray-700">
